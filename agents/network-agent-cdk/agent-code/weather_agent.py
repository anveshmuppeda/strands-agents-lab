"""
Weather Agent — Deployed on Amazon Bedrock AgentCore Runtime via Python CDK.

This is the agent code that runs inside the container on AgentCore.
"""
...
# SSL context — AgentCore containers may not have all root certs
