"""
AWS Network Agent — Amazon Bedrock AgentCore Runtime

Diagnoses AWS networking issues using AWS APIs. Deployed as a managed
serverless endpoint via AgentCore Runtime.
"""
